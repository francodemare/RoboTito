...
#define LED2_ClrVal()    LEDpin4_ClrVal() /* put the pin on low level */
#define LED2_SetVal()    LEDpin4_SetVal() /* put the pin on high level */
#define LED2_SetInput()  LEDpin4_SetInput() /* use the pin as input pin */
#define LED2_SetOutput() LEDpin4_SetOutput() /* use the pin as output pin */

#define LED2_PARSE_COMMAND_ENABLED  0 /* set to 1 if method ParseCommand() is present, 0 otherwise */


#define LED2_On() LEDpin4_ClrVal()
/*
** ===================================================================
...
#define LED2_Off() LEDpin4_SetVal()
/*
** ===================================================================
...
#define LED2_Neg() LEDpin4_NegVal()
/*
** ===================================================================
...
#define LED2_Get() (!(LEDpin4_GetVal()))
/*
** ===================================================================
