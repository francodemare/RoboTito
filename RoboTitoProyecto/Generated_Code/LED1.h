...
#define LED1_ClrVal()    LEDpin3_ClrVal() /* put the pin on low level */
#define LED1_SetVal()    LEDpin3_SetVal() /* put the pin on high level */
#define LED1_SetInput()  LEDpin3_SetInput() /* use the pin as input pin */
#define LED1_SetOutput() LEDpin3_SetOutput() /* use the pin as output pin */

#define LED1_PARSE_COMMAND_ENABLED  0 /* set to 1 if method ParseCommand() is present, 0 otherwise */


#define LED1_On() LEDpin3_ClrVal()
/*
** ===================================================================
...
#define LED1_Off() LEDpin3_SetVal()
/*
** ===================================================================
...
#define LED1_Neg() LEDpin3_NegVal()
/*
** ===================================================================
...
#define LED1_Get() (!(LEDpin3_GetVal()))
/*
** ===================================================================
